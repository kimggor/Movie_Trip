  ...
  return (
    <div className="w-3/5 h-[700px] bg-[#c2c2c2] rounded-xl flex flex-col items-center ">
      ...
      <div className="w-full mt-[120px] relative">
        <RankProfile name="sejung" point={1500} rank={1} isRank={true} />
        <RankProfile name="sejung" point={1500} rank={2} isRank={false} />
        <RankProfile name="sejung" point={1500} rank={3} isRank={false} />
      </div>
    </div>
  );
}
